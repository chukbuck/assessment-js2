...
class Employee {
  ...
  // ! This is important. "...empOne" needs to come before "name: 'Nick'".
  // ! Try switching the order and printing to the console to see why.
...
getEmployees() {
  ...
  addEmployee(name) {
    // ! Once again, using the "new" keyword to create an instance of
    // ! the Employee class
...
manager.addEmployee('Tupac Shakur')
